  ...
  <div class="container text-center text-md-start">
    <div class="row">
      ...
      <div class="col-md-4 mb-4">
        <h5 class="text-uppercase fw-bold mb-3">À propos</h5>
        <p>GRAD est le leader français des aménagements extérieurs en bois et matériaux innovants.</p>
        <a href="contact.php" class="btn btn-warning mt-3 fw-bold">Contactez-nous</a>
      </div>
    ...
    <div class="text-center">
      <p class="mb-0">&copy; 2025 GRAD. Tous droits réservés.</p>
    </div>
  </div>
</footer>
